...
<body>
    ...
    <h2>Formulaire</h2>
    <form action="/TP_01/index.php?action=Volheuredepart" method="POST">
        <label for="fabricants">Heure de départ :</label>
        <input type="time" id="heure" name="heuredep" required><br><br>
